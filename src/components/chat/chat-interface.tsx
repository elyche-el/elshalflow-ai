...
const MODELS: ModelDef[] = [
  ...
  { id: "mistral-large-latest",     name: "Mistral Large",      free: false, vendor: "Mistral", desc: "⚡ Flagship 128K · Multimodal", provider: "mistral" },
      ...
      <div ref={scrollRef} className="flex-1 overflow-y-auto pb-4">
        {messages.length===0?(
          <div className="flex flex-col items-center justify-center h-full px-6 text-center py-12">
            ...
            <p className="text-muted-foreground text-sm max-w-xs mb-6">Assistant IA multi-provider. OpenRouter + Mistral AI (25 modeles).</p>
