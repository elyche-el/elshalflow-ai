...
const PROVIDERS = [
  ...
  { id: "agentrouter", name: "AgentRouter", desc: "200$ credits gratuits, 50+ providers", icon: "🟢" },
] as const;
...
const MODELS: ModelDef[] = [
  ...
  { id: "poolside/laguna-s-2.1:free", name: "Laguna S 2.1", free: true, vendor: "Poolside", desc: "Coding gratuit", provider: "openrouter" },
...
export function ChatInterface({ convId: initialConvId }: { convId?: string }) {
  ...
  const [hasProviderKeys, setHasProviderKeys] = useState<Record<ProviderId,boolean>>({ openrouter: false, agentrouter: false });
      ...
      <div ref={scrollRef} className="flex-1 overflow-y-auto pb-4">
        {messages.length===0?(
          <div className="flex flex-col items-center justify-center h-full px-6 text-center py-12">
            ...
            <p className="text-muted-foreground text-sm max-w-xs mb-6">Assistant IA multi-provider. OpenRouter + AgentRouter.</p>
