...
const PROVIDERS = [
  ...
  { id: "mistral",     name: "Mistral AI",  desc: "Mistral Large, Small, Codestral",     icon: "🔴" },
] as const;
...
const MODELS: ModelDef[] = [
  ...
  { id: "codestral-latest", name: "Codestral", free: false, vendor: "Mistral", desc: "Code FIM", provider: "mistral" },
  { id: "ministral-8b-latest", name: "Ministral 8B", free: false, vendor: "Mistral", desc: "Leger", provider: "mistral" },
  { id: "ministral-3b-latest", name: "Ministral 3B", free: false, vendor: "Mistral", desc: "Ultra-leger", provider: "mistral" },
  { id: "mistral-medium-latest", name: "Mistral Medium", free: false, vendor: "Mistral", desc: "Milieu", provider: "mistral" },
];
      ...
      <div ref={scrollRef} className="flex-1 overflow-y-auto pb-4">
        {messages.length===0?(
          <div className="flex flex-col items-center justify-center h-full px-6 text-center py-12">
            ...
            <p className="text-muted-foreground text-sm max-w-xs mb-6">Assistant IA multi-provider. OpenRouter + Mistral AI.</p>
